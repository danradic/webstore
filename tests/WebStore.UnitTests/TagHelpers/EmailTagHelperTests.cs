using WebStore.Website.TagHelpers;
...
namespace WebStore.UnitTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        public void Process_ShouldGenerateEmailLink () 
        {
            ...
            Assert.Equal("mailto:test@webstore.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
